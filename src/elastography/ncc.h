...
//#define DEBUG_THRESHOLD_VALUES 1
    ...
    extern float CROSSCORRELATION_THRESHOLD;
    extern float NEGATIVE_THRESHOLD_STD_DEVIATION;
    extern float NEGATIVE_THRESHOLD_CONSTANT;
    extern float POSITIVE_THRESHOLD_STD_DEVIATION;
    extern float POSITIVE_THRESHOLD_CONSTANT;
    extern float STRAIN_VALUE_NEGATIVE_NOISE;
    extern float STRAIN_VALUE_POSITIVE_NOISE;
    ...
    void count_sampl_pts(int uncomp_matrix_x, int uncomp_matrix_y, int window,
            ...
            float *Over_T, int *Over_S, float *max_strain,
            int *num_strain_points, int *correlation_size, float F0, float FS);
    ...
    void ncc_slow(int height, int width, short int * comp_matrix_short,
            ...
            int strain_or_displacement, int NOF, int ncc_window,
